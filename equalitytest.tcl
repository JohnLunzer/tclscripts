catch {namespace delete test_almost_equal} ;# Start with a clean namespace

namespace eval test_almost_equal {
    ...
    proc isClose {a b {prec 9}} {
        proc toCoeff {n prec} {
            ...
            return [format %0.f "[string range $trim 0 [expr {$prec-1}]].[string index $trim $prec]"]
        }
